...
export function HeroSection() {
    ...
    return (
        <section
            id="home"
            ref={containerRef}
            className="relative h-screen flex flex-col justify-end overflow-hidden pt-20 pb-20"
        >
            <div className="container px-4 md:px-6 relative z-10 flex flex-col h-[85%] justify-end">

                {/* Background Layer (Parallax Text) */}
                <motion.div
                    style={{ y: yBackground }}
                    className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-full select-none pointer-events-none z-0"
                >
                    <motion.h1
            ...
            <motion.div
                ...
                className="absolute bottom-4 left-0 w-full border-y border-border/50 py-3 bg-background/50 backdrop-blur-sm overflow-hidden"
            >
